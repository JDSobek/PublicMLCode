"""Trying to make a full 3D version of a UNet using a modified ResNet as the encoder.
Runs for Resnet34 and Resnet18.  ResNet50 and others end with too many channels, needs more work to make run."""
...
class ResNet3DUNet(torch.nn.Module):
...
if __name__ == '__main__':
    ...
    # print(resnetmodel)
    model = ResNet3DUNet(resnetmodel, input_depth=5, num_classes=2)
